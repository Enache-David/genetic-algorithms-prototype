...
for g in range(generations):
    ...
    while len(crossover) > 1:
        ...
        cross_point = random.randrange(l) # aleg aleator pozitia unui bit
        ...
        if len(crossover) % 2 == 0:
            ...
            if g == 0:
                ...
                out_file.write(f'{x0} {x1} punct {cross_point} - rezultat:\n')
            
            aux = x0
            x0 = x0[:cross_point] + x1[cross_point:]
            x1 = x1[:cross_point] + aux[cross_point:]
            
            if g == 0:
                out_file.write(f'{x0} {x1}\n')
            ...
            if g == 0:
                ...
                out_file.write(f'{x0} {x1} {x2} punct {cross_point} - rezultat:\n')
            
            aux = x0
            x0 = x0[:cross_point] + x1[cross_point:]
            x1 = x1[:cross_point] + x2[cross_point:]
            x2 = x2[:cross_point] + aux[cross_point:]
            
            if g == 0:
                out_file.write(f'{x0} {x1} {x2}\n')
    ...
    for i in range(population_size):
        ...
        if u < pm:
            ...
            if g == 0:
                out_file.write(f'{i + 1:>4}: {x} pozitia {p + 1} - rezultat:\n')
    ...
    # out_file.write(f'Generatia {g + 1:>4}: {f_max}\n')
